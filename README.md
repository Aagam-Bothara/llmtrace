...
| Experiment planner (`llmtrace plan`, `llmtrace run --plan`) | Validated (RTX A5000, opt-125m): the plan from a real baseline run proposed `long_prefill_token_threshold` 1024 and 512; six engines ran one process each; `decide` selected the 512 cap (short TTFT p95 4.8 ms vs 8.3 ms baseline, goodput 98% vs 89%, long TTFT +62%); the effect grows monotonically with the cap (1024: -24%, 512: -41%, 256: -64% short TTFT p95) |
